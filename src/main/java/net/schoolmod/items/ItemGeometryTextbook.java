...
public class ItemGeometryTextbook extends Item {

	public ItemGeometryTextbook(Properties properties) {
		super(properties);
	}
	...
	public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
		tooltip.add(new StringTextComponent("Clears out a 5x5x5 area around you").applyTextStyle(TextFormatting.AQUA));
	}
